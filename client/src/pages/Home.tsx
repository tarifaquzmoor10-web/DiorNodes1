    ...
    <div className="min-h-screen selection:bg-primary/30 selection:text-white">
      ...
      <main>
        ...
        <section id="services" className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
          {/* subtle particle or glow background behind the section */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#00F0FF]/5 to-[#8A2BE2]/5 mix-blend-overlay pointer-events-none rounded-[3rem]"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] bg-gradient-to-r from-[#00F0FF]/10 to-[#8A2BE2]/10 rounded-full blur-[120px] pointer-events-none"></div>

          <SectionHeading 
            title="Hosting Services" 
            subtitle="Explore our range of premium hosting solutions designed for performance and reliability."
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <motion.div
              ...
              className="glass-panel p-8 rounded-3xl relative overflow-hidden group flex flex-col h-full"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#00F0FF] opacity-10 rounded-bl-[100px] transition-opacity duration-500 group-hover:opacity-20" />
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#00F0FF] to-[#0080FF] p-[1px] mb-6 shadow-[0_0_20px_rgba(0,240,255,0.2)] group-hover:shadow-[0_0_30px_rgba(0,240,255,0.4)] transition-shadow duration-300">
                <div className="w-full h-full bg-[#05050A] rounded-[15px] flex items-center justify-center">
                  <Server className="w-8 h-8 text-[#00F0FF]" />
                </div>
              </div>
              <h3 className="text-2xl font-display font-bold text-white mb-4">Premium Minecraft Server Hosting</h3>
            ...
            <motion.div
              ...
              className="glass-panel p-8 rounded-3xl relative overflow-hidden group flex flex-col h-full"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#5865F2] opacity-10 rounded-bl-[100px] transition-opacity duration-500 group-hover:opacity-20" />
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#5865F2] to-[#4752C4] p-[1px] mb-6 shadow-[0_0_20px_rgba(88,101,242,0.2)] group-hover:shadow-[0_0_30px_rgba(88,101,242,0.4)] transition-shadow duration-300">
                <div className="w-full h-full bg-[#05050A] rounded-[15px] flex items-center justify-center">
              ...
              <h3 className="text-2xl font-display font-bold text-white mb-4">Discord Bot Hosting</h3>
              <p className="text-white/60 leading-relaxed mb-8 flex-1">
            ...
            <motion.div
              ...
              className="glass-panel p-8 rounded-3xl relative overflow-hidden group flex flex-col h-full"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#8A2BE2] opacity-10 rounded-bl-[100px] transition-opacity duration-500 group-hover:opacity-20" />
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#8A2BE2] to-[#B026FF] p-[1px] mb-6 shadow-[0_0_20px_rgba(138,43,226,0.2)] group-hover:shadow-[0_0_30px_rgba(138,43,226,0.4)] transition-shadow duration-300">
                <div className="w-full h-full bg-[#05050A] rounded-[15px] flex items-center justify-center">
                  <Globe className="w-8 h-8 text-[#8A2BE2]" />
                </div>
              </div>
              <h3 className="text-2xl font-display font-bold text-white mb-4">24/7 VPS Hosting</h3>
              <p className="text-white/60 leading-relaxed mb-8 flex-1">
